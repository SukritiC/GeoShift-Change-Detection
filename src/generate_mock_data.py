...
def create_mock_geotiff(filename, width=100, height=100, scenario="default"):
    ...
    if scenario == "default":
        ...
        data[0, center_y-size:center_y+size, center_x-size:center_x+size] = 100
        data[3, center_y-size:center_y+size, center_x-size:center_x+size] = 100
        ...
        data[0, center_y-size:center_y+size, center_x-size:center_x+size] = 50
        data[3, center_y-size:center_y+size, center_x-size:center_x+size] = 200
...
if __name__ == "__main__":
    ...
    create_mock_geotiff("data/case1_before.tif", scenario="no_change") # Base vegetation
    create_mock_geotiff("data/case1_after.tif", scenario="default")
    print("- Case 1: Standard Deforestation (data/case1_before.tif, data/case1_after.tif)")
